...
const categories = [
  ...
  { id: 2,img:"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_96/NI_CATALOG/IMAGES/CIW/2025/5/14/90edc829-294e-4964-b4b6-441567e171e6_f2a65d2b-7864-42dc-9e89-7c258971e2e9", name: "Leafy and Seasonings" },
  { id: 3,img:"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_96/NI_CATALOG/IMAGES/CIW/2025/5/14/021af0e5-0edd-4f99-b45d-7e2d9e45cda4_4baa8d1b-4523-41b8-9b50-579018abef3d", name: "Exotic Vegetables" },
  { id: 4,img:"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_96/740c89a8c673942e12340747d6947993", name: "Festive Essentials" },
  { id: 5,img:"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_96/NI_CATALOG/IMAGES/CIW/2025/3/19/609e1e73-ef28-4d72-bdec-139e414d40e1_3a95431a-6c61-4b42-95b2-965640f7600b", name: "Flowers & Plants" },
];
      ...
      <div className="w-[80%] mx-auto h-screen bg-gray-200 flex">
        ...
        <div className="flex-1 p-6">
          ...
          <div className="flex gap-3 mb-6">
            {["Exotics", "Gourd", "Beans", "Capsicum", "Type", "Sort By"].map(
              (item, i) => (
                <button
                  key={i}
